...
- deduplicate: check if recipe already exists by `name`, `source_url`, and normalized ingredient set, and return `error_code: duplicate_recipe` if already exists (optionally offer update path).
